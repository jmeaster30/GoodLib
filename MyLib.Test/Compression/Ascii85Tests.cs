...
public class Ascii85Tests
{
    ...
    {
        CompressionTestHelpers.TestFilter(new Ascii85(), "i did it :)");
    }
    
    [Fact]
    public void TestMustTestThis()
    {
        CompressionTestHelpers.TestFilter(new Ascii85(), "I must test this a bunch");
    }
    
    [Fact]
    public void TestLeviathan()
    {
        CompressionTestHelpers.TestFilter(new Ascii85(), "Man is distinguished, not only by his reason, but by this singular passion from other animals, which is a lust of the mind, that by a perseverance of delight in the continued and indefatigable generation of knowledge, exceeds the short vehemence of any carnal pleasure.");
    }
    
    [Fact]
    public void Test1()
    {
        CompressionTestHelpers.TestFilter(new Ascii85(), "this is a test of the lzw filter");
    }
    
    [Fact]
    public void Test2()
    {
        CompressionTestHelpers.TestFilter(new Ascii85(), "this?");
    }
    
    [Fact]
    public void Test3()
    {
        CompressionTestHelpers.TestFilter(new Ascii85(), @"

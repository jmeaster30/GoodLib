...
public class AsciiHexTests
{
    ...
    public void Test1()
    {
        CompressionTestHelpers.TestFilter(new AsciiHex(), "this is a test of the lzw filter");
    }
    
    [Fact]
    public void Test2()
    {
        CompressionTestHelpers.TestFilter(new AsciiHex(), "this?");
    }
    
    [Fact]
    public void Test3()
    {
        CompressionTestHelpers.TestFilter(new AsciiHex(), @"
